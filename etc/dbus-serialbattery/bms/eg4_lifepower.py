...
class EG4_Lifepower(Battery):
    ...
    def get_settings(self):
        ...
        if hardware_version:
            ...
            logger.info(
                f"Hardware Version for address {bytearray_to_string(self.address)}: {self.hardware_version}"
            )
        ...
        if version:
            ...
            logger.info(
                f"Firmware Version for address {bytearray_to_string(self.address)}: {self.version}"
            )
